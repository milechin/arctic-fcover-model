...
tileList="/projectnb/modislc/users/seamorez/HLS_FCover/scripts/assess_tiles.txt" 
...
do
   ...
   while read -r tile
	...
	logArg="-o ${logDir}Run_Peak_${i}_${tile}_${jobTime}.txt"
        qsub $nameArg $logArg $nodeArgs model_runTiles_SCC_A1.sh $tile $i
