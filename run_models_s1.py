...
# Read in models
trees_regressor = pickle.load(open(model_traindir+"trees_rfr_s1.pickle", "rb"))
shrub_regressor = pickle.load(open(model_traindir+"shrub_rfr_s1.pickle", "rb"))
herb_regressor = pickle.load(open(model_traindir+"herb_rfr_s1.pickle", "rb"))
barren_regressor = pickle.load(open(model_traindir+"barren_rfr_s1.pickle", "rb"))
water_regressor = pickle.load(open(model_traindir+"water_rfr_s1.pickle", "rb"))

# Read in raster
full_stack = rasterio.open(outdir+year+'/'+tile+'/feats_full_s1_'+year+'.tif','r')
...
# Correct bias
# Read in bias models 
water_bias = pickle.load(open(model_traindir+"water_bias_s1.pickle", "rb"))
barren_bias = pickle.load(open(model_traindir+"barren_bias_s1.pickle", "rb"))
herb_bias = pickle.load(open(model_traindir+"herb_bias_s1.pickle", "rb"))
shrub_bias = pickle.load(open(model_traindir+"shrub_bias_s1.pickle", "rb"))
trees_bias = pickle.load(open(model_traindir+"trees_bias_s1.pickle", "rb"))
...
with rasterio.open(model_outdir+year+'/FCover_'+tile+'_'+year+'_rfr_s1.tif', 'w', **meta2) as dst:
