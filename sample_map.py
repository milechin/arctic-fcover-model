...
# Read in inputs
image_fn = '/projectnb/modislc/users/seamorez/HLS_FCover/Maxar_NAtundra/training/2.2.2/assessment_imgs/GE01_20170802_7_clipped.tif'
...
allocation = np.array([45, 18, 387, 50], dtype=int)
# if allocation is None:
#     if method != 'random':
...
# Parse mask values
mask = np.array([0, 32767], dtype=int)
# if mask.lower() == 'none':
#     mask = None
...
output_vector = '/projectnb/modislc/users/seamorez/HLS_FCover/Maxar_NAtundra/training/2.2.2/Maxar_assessment_pairs/GE01_20170802_shps.shp'
