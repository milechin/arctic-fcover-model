...
# Read in models
trees_regressor = pickle.load(open(model_traindir+"trees_rfr_peak.pickle", "rb"))
shrub_regressor = pickle.load(open(model_traindir+"shrub_rfr_peak.pickle", "rb"))
herb_regressor = pickle.load(open(model_traindir+"herb_rfr_peak.pickle", "rb"))
barren_regressor = pickle.load(open(model_traindir+"barren_rfr_peak.pickle", "rb"))
water_regressor = pickle.load(open(model_traindir+"water_rfr_peak.pickle", "rb"))
...
# Correct bias
# Read in bias models 
water_bias = pickle.load(open(model_traindir+"water_bias_peak.pickle", "rb"))
barren_bias = pickle.load(open(model_traindir+"barren_bias_peak.pickle", "rb"))
herb_bias = pickle.load(open(model_traindir+"herb_bias_peak.pickle", "rb"))
shrub_bias = pickle.load(open(model_traindir+"shrub_bias_peak.pickle", "rb"))
trees_bias = pickle.load(open(model_traindir+"trees_bias_peak.pickle", "rb"))
...
with rasterio.open(model_outdir+year+'/FCover_'+tile+'_'+year+'_rfr_peak.tif', 'w', **meta2) as dst:
